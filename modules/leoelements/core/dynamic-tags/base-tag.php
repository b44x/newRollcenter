...
abstract class Base_Tag extends Controls_Stack {
	...
	public function print_panel_template() {
		...
		?><#
		var key = <?php echo Leo_Helper::esc_html( $panel_template_setting_key ); ?>;

		if ( key ) {
			var settingsKey = "<?php echo Leo_Helper::esc_html( $panel_template_setting_key ); ?>";
	...
	final protected function init_controls() {
		...
		$this->start_controls_section( 'settings', [
			'label' => Leo_Helper::__( 'Settings', 'elementor' ),
		] );
