...
class Manager {
	...
	public function get_tags() {
		 ...
		 */
		Leo_Helper::do_action( 'elementor/dynamic_tags/register_tags', $this );
	...
	public function ajax_render_tags( $data ) {
		 ...
		 * @since 2.0.0
		 */
		Leo_Helper::do_action( 'elementor/dynamic_tags/before_render' );
		 ...
		 * @since 2.0.0
		 */
		Leo_Helper::do_action( 'elementor/dynamic_tags/after_render' );
	...
	private function add_actions() {
		...
		Leo_Helper::add_action( 'elementor/css-file/post/enqueue', [ $this, 'after_enqueue_post_css' ] );
	}
}
