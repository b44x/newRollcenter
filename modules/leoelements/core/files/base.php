...
abstract class Base {
	...
	public function __construct( $file_name ) {
		 ...
		 */
		$file_name = Leo_Helper::apply_filters( 'elementor/files/file_name', $file_name, $this );
	...
	protected function load_meta() {
		return Leo_Helper::get_option( static::META_KEY );
	}
	...
	protected function update_meta( $meta ) {
		Leo_Helper::update_option( static::META_KEY, $meta );
	}
	...
	protected function delete_meta() {
		Leo_Helper::delete_option( static::META_KEY );
	}
	...
	private static function get_wp_uploads_dir() {
		return self::$wp_uploads_dir = [
			'basedir' => LEOELEMENTS_ASSETS_PATH . 'upload/',
			'baseurl' => LEOELEMENTS_ASSETS_URL . 'upload/'
		];
	}
