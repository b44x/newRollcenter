...
abstract class Base extends Base_File {
	...
	protected function use_external_file() {
		return 'external' == Leo_Helper::get_option( 'elementor_css_print_method' );
	}
	...
	public function enqueue() {
		 ...
		 */
		//Leo_Helper::do_action_deprecated( "elementor/{$name}-css-file/enqueue", [ $this ], '2.0.0', "elementor/css-file/{$name}/enqueue" );
		 ...
		 * @param Base $this The current CSS file.
		 */
		Leo_Helper::do_action( "elementor/css-file/{$name}/enqueue", $this );
	}
	...
	protected function parse_content() {
		 ...
		 * @param Base $this The current CSS file.
		 */
		//Leo_Helper::do_action_deprecated( "elementor/{$name}-css-file/parse", [ $this ], '2.0.0', "elementor/css-file/{$name}/parse" );
		 ...
		 * @param Base $this The current CSS file.
		 */
		Leo_Helper::do_action( "elementor/css-file/{$name}/parse", $this );
