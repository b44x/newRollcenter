...
namespace LeoElements\Core\Responsive\Files;

use LeoElements\Core\Files\Base;
...
class Frontend extends Base {
	...
	public function parse_content() {
		...
		$file_content = preg_replace_callback( '/LEOELEMENTS_SCREEN_([A-Z]+)_([A-Z]+)/', function ( $placeholder_data ) use ( $breakpoints_keys, $breakpoints ) {
	...
	protected function update_meta( $meta ) {
		...
		Leo_Helper::update_option( static::META_KEY, $option );
	}
	...
	private function load_meta_option() {
		$option = Leo_Helper::get_option( static::META_KEY );
