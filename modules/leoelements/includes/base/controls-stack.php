...
use LeoElements\Core\DynamicTags\Manager;
...
abstract class Controls_Stack extends Base_Object {
	...
	public function add_control( $id, array $args, $options = [] ) {
		...
		if ( empty( $args['type'] ) || ! in_array( $args['type'], [ Controls_Manager::SECTION, Controls_Manager::WP_WIDGET ], true ) ) {
			...
			} elseif ( empty( $args['section'] ) && ( ! $options['overwrite'] || Leo_Helper::is_wp_error( Plugin::$instance->controls_manager->get_control_from_stack( $this->get_unique_name(), $id ) ) ) ) {
	...
	public function start_controls_section( $section_id, array $args = [] ) {
		 ...
		 */
		Leo_Helper::do_action( 'elementor/element/before_section_start', $this, $section_id, $args );
		 ...
		 * @param array          $args Section arguments.
		 */
		Leo_Helper::do_action( "elementor/element/{$section_name}/{$section_id}/before_section_start", $this, $args );
		 ...
		 * @param array          $args       Section arguments.
		 */
		Leo_Helper::do_action( 'elementor/element/after_section_start', $this, $section_id, $args );
		 ...
		 * @param array          $args Section arguments.
		 */
		Leo_Helper::do_action( "elementor/element/{$section_name}/{$section_id}/after_section_start", $this, $args );
	}
	...
	public function end_controls_section() {
		 ...
		 * @param array          $args       Section arguments.
		 */
		Leo_Helper::do_action( 'elementor/element/before_section_end', $this, $section_id, $args );
		 ...
		 * @param array          $args Section arguments.
		 */
		Leo_Helper::do_action( "elementor/element/{$stack_name}/{$section_id}/before_section_end", $this, $args );
		 ...
		 * @param array          $args       Section arguments.
		 */
		Leo_Helper::do_action( 'elementor/element/after_section_end', $this, $section_id, $args );
		 ...
		 * @param array          $args Section arguments.
		 */
		Leo_Helper::do_action( "elementor/element/{$stack_name}/{$section_id}/after_section_end", $this, $args );
	}
	...
	public function print_template() {
		 ...
		 */
		$template_content = Leo_Helper::apply_filters( "elementor/{$element_type}/print_template", $template_content, $this );

		if ( empty( $template_content ) ) {
			return;
		}
		?>
		<script type="text/html" id="tmpl-elementor-<?php echo Leo_Helper::esc_attr( $this->get_name() ); ?>-content">
