...
class Control_Animation extends Base_Data_Control {
	...
	public static function get_animations() {
		 ...
		 */
		$additional_animations = Leo_Helper::apply_filters( 'elementor/controls/animations/additional_animations', [] );
		...
		<div class="elementor-control-field">
			...
			<div class="elementor-control-input-wrapper">
				<select id="<?php echo $control_uid; ?>" data-setting="{{ data.name }}">
					...
					<option value="none"><?php echo Leo_Helper::__( 'None', 'elementor' ); ?></option>
