			...
			<div class="elementor-control-input-wrapper">
				...
				<div class="elementor-control-media__content elementor-control-tag-area">
					<div class="elementor-control-gallery-status">
						...
						<span class="elementor-control-gallery-clear">(<?php echo Leo_Helper::__( 'Clear', 'elementor' ); ?>)</span>
					</div>
					<div class="elementor-control-gallery-thumbnails"></div>
					<button class="elementor-button elementor-control-gallery-add"><?php echo Leo_Helper::__( 'Add Images', 'elementor' ); ?></button>
				</div>
			</div>
		</div>
		<?php
