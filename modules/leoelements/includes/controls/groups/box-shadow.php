...
class Group_Control_Box_Shadow extends Group_Control_Base {
	...
	protected function init_fields() {
		...
		$controls['box_shadow'] = [
			'label' => Leo_Helper::_x( 'Box Shadow', 'Box Shadow Control', 'elementor' ),
		...
		$controls['box_shadow_position'] = [
			'label' => Leo_Helper::_x( 'Position', 'Box Shadow Control', 'elementor' ),
			'type' => Controls_Manager::SELECT,
			'options' => [
				' ' => Leo_Helper::_x( 'Outline', 'Box Shadow Control', 'elementor' ),
				'inset' => Leo_Helper::_x( 'Inset', 'Box Shadow Control', 'elementor' ),
			],
			'default' => ' ',
			'render_type' => 'ui',
		];
	...
	protected function get_default_options() {
		return [
			'popover' => [
				'starter_title' => Leo_Helper::_x( 'Box Shadow', 'Box Shadow Control', 'elementor' ),
