...
class Group_Control_Typography extends Group_Control_Base {
	...
	protected function init_fields() {
		...
		$fields['font_family'] = [
			'label' => Leo_Helper::_x( 'Family', 'Typography Control', 'elementor' ),
		...
		$fields['font_size'] = [
			'label' => Leo_Helper::_x( 'Size', 'Typography Control', 'elementor' ),
		...
		$fields['font_weight'] = [
			'label' => Leo_Helper::_x( 'Weight', 'Typography Control', 'elementor' ),
		...
		$fields['text_transform'] = [
			'label' => Leo_Helper::_x( 'Transform', 'Typography Control', 'elementor' ),
			'type' => Controls_Manager::SELECT,
			'default' => '',
			'options' => [
				'' => Leo_Helper::__( 'Default', 'elementor' ),
				'uppercase' => Leo_Helper::_x( 'Uppercase', 'Typography Control', 'elementor' ),
				'lowercase' => Leo_Helper::_x( 'Lowercase', 'Typography Control', 'elementor' ),
				'capitalize' => Leo_Helper::_x( 'Capitalize', 'Typography Control', 'elementor' ),
				'none' => Leo_Helper::_x( 'Normal', 'Typography Control', 'elementor' ),
			],
		];

		$fields['font_style'] = [
			'label' => Leo_Helper::_x( 'Style', 'Typography Control', 'elementor' ),
			'type' => Controls_Manager::SELECT,
			'default' => '',
			'options' => [
				'' => Leo_Helper::__( 'Default', 'elementor' ),
				'normal' => Leo_Helper::_x( 'Normal', 'Typography Control', 'elementor' ),
				'italic' => Leo_Helper::_x( 'Italic', 'Typography Control', 'elementor' ),
				'oblique' => Leo_Helper::_x( 'Oblique', 'Typography Control', 'elementor' ),
			],
		];

		$fields['text_decoration'] = [
			'label' => Leo_Helper::_x( 'Decoration', 'Typography Control', 'elementor' ),
			'type' => Controls_Manager::SELECT,
			'default' => '',
			'options' => [
				'' => Leo_Helper::__( 'Default', 'elementor' ),
				'underline' => Leo_Helper::_x( 'Underline', 'Typography Control', 'elementor' ),
				'overline' => Leo_Helper::_x( 'Overline', 'Typography Control', 'elementor' ),
				'line-through' => Leo_Helper::_x( 'Line Through', 'Typography Control', 'elementor' ),
				'none' => Leo_Helper::_x( 'None', 'Typography Control', 'elementor' ),
			],
		];

		$fields['line_height'] = [
			'label' => Leo_Helper::_x( 'Line-Height', 'Typography Control', 'elementor' ),
			'type' => Controls_Manager::SLIDER,
			'desktop_default' => [
				'unit' => 'em',
			],
		...
		$fields['letter_spacing'] = [
			'label' => Leo_Helper::_x( 'Letter Spacing', 'Typography Control', 'elementor' ),
			'type' => Controls_Manager::SLIDER,
			'range' => [
				'px' => [
					'min' => -5,
	...
	protected function get_default_options() {
		return [
			'popover' => [
				...
				'starter_title' => Leo_Helper::_x( 'Typography', 'Typography Control', 'elementor' ),
				'settings' => [
					'render_type' => 'ui',
				],
			],
