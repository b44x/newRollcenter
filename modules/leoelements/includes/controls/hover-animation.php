...
class Control_Hover_Animation extends Base_Data_Control {
	...
	public static function get_animations() {
		if ( is_null( self::$_animations ) ) {
			 ...
			 */
			$additional_animations = Leo_Helper::apply_filters( 'elementor/controls/hover_animations/additional_animations', $additional_animations );
		...
		<div class="elementor-control-field">
			...
			<div class="elementor-control-input-wrapper">
				<select id="<?php echo $control_uid; ?>" data-setting="{{ data.name }}">
					<option value=""><?php echo Leo_Helper::__( 'None', 'elementor' ); ?></option>
