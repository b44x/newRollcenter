	...
	public function content_template() {
		...
		<div class="elementor-control-field">
			...
			<div class="elementor-control-input-wrapper">
				<select id="<?php echo $control_uid; ?>" class="elementor-control-icon" data-setting="{{ data.name }}" data-placeholder="<?php echo Leo_Helper::__( 'Select Icon', 'elementor' ); ?>">
					<option value=""><?php echo Leo_Helper::__( 'Select Icon', 'elementor' ); ?></option>
