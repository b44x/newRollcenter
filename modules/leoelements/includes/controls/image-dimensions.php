	...
	public function content_template() {
		if ( ! $this->is_image_editor_supports() ) : ?>
			<div class="elementor-panel-alert elementor-panel-alert-danger">
				<?php echo Leo_Helper::__( 'The server does not have ImageMagick or GD installed and/or enabled! Any of these libraries are required for WordPress to be able to resize images. Please contact your server administrator to enable this before continuing.', 'elementor' ); ?>
			</div>
			<?php
			return;
		endif;
		...
		<div class="elementor-control-field">
			...
			<div class="elementor-control-input-wrapper">
				<div class="elementor-image-dimensions-field">
					...
					<label for="<?php echo $control_uid; ?>" class="elementor-image-dimensions-field-description"><?php echo Leo_Helper::__( 'Width', 'elementor' ); ?></label>
				</div>
				...
				<div class="elementor-image-dimensions-field">
					...
					<label for="<?php echo $control_uid; ?>" class="elementor-image-dimensions-field-description"><?php echo Leo_Helper::__( 'Height', 'elementor' ); ?></label>
				</div>
				<button class="elementor-button elementor-button-success elementor-image-dimensions-apply-button"><?php echo Leo_Helper::__( 'Apply', 'elementor' ); ?></button>
			</div>
		</div>
		<?php
	}
