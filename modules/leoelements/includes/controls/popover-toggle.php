		...
		<div class="elementor-control-field">
			...
			<div class="elementor-control-input-wrapper">
				...
				<label class="elementor-control-popover-toggle-toggle-label" for="<?php echo $control_uid; ?>-custom">
					...
					<span class="elementor-screen-only"><?php echo Leo_Helper::__( 'Edit', 'elementor' ); ?></span>
				</label>
				<input id="<?php echo $control_uid; ?>-default" type="radio" name="elementor-choose-{{ data.name }}-{{ data._cid }}" value="">
				<label class="elementor-control-popover-toggle-reset-label tooltip-target" for="<?php echo $control_uid; ?>-default" data-tooltip="<?php echo Leo_Helper::__( 'Back to default', 'elementor' ); ?>" data-tooltip-pos="s">
					<i class="fa fa-repeat" aria-hidden="true"></i>
					<span class="elementor-screen-only"><?php echo Leo_Helper::__( 'Back to default', 'elementor' ); ?></span>
				</label>
			</div>
		</div>
		<?php
