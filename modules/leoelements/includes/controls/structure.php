	...
	public function content_template() {
		...
		<div class="elementor-control-field">
			<div class="elementor-control-input-wrapper">
				<div class="elementor-control-structure-title"><?php echo Leo_Helper::__( 'Structure', 'elementor' ); ?></div>
				...
				<div class="elementor-control-structure-reset">
					...
					<?php echo Leo_Helper::__( 'Reset Structure', 'elementor' ); ?>
				</div>
				<#
				var morePresets = getMorePresets();

				if ( morePresets.length > 1 ) { #>
					<div class="elementor-control-structure-more-presets-title"><?php echo Leo_Helper::__( 'More Structures', 'elementor' ); ?></div>
