...
class Control_URL extends Control_Base_Multiple {
	...
	protected function get_default_settings() {
		return [
			'label_block' => true,
			'show_external' => true,
			'placeholder' => Leo_Helper::__( 'Paste URL or type', 'elementor' ),
			'autocomplete' => true,
		];
	}
	...
	public function content_template() {
		...
		<div class="elementor-control-field elementor-control-url-external-{{{ data.show_external ? 'show' : 'hide' }}}">
			...
			<div class="elementor-control-input-wrapper">
				...
				<label for="<?php echo $more_input_control_uid; ?>" class="elementor-control-url-more tooltip-target" data-tooltip="<?php echo Leo_Helper::__( 'Link Options', 'elementor' ); ?>">
				...
				<div class="elementor-control-url-more-options">
					<div class="elementor-control-url-option">
						...
						<label for="<?php echo $is_external_control_uid; ?>"><?php echo Leo_Helper::__( 'Open in new window', 'elementor' ); ?></label>
					</div>
					<div class="elementor-control-url-option">
						<input id="<?php echo $nofollow_control_uid; ?>" type="checkbox" class="elementor-control-url-option-input" data-setting="nofollow">
						<label for="<?php echo $nofollow_control_uid; ?>"><?php echo Leo_Helper::__( 'Add nofollow', 'elementor' ); ?></label>
					</div>
				</div>
			</div>
		</div>
