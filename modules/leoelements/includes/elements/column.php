...
class Element_Column extends Element_Base {
	...
	public function get_title() {
		return Leo_Helper::__( 'Column', 'elementor' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_responsive_control(
			'_inline_size',
			[
				'label' => Leo_Helper::__( 'Column Width', 'elementor' ) . ' (%)',
		...
		$this->add_responsive_control(
			...
			[
				...
				'options' => [
					...
					'center' => Leo_Helper::__( 'Middle', 'elementor' ),
		...
		$this->add_responsive_control(
			'align',
			[
				'label' => Leo_Helper::__( 'Horizontal Align', 'elementor' ),
				'type' => Controls_Manager::SELECT,
				'default' => '',
				'options' => [
					'' => Leo_Helper::__( 'Default', 'elementor' ),
					'flex-start' => Leo_Helper::__( 'Start', 'elementor' ),
					'center' => Leo_Helper::__( 'Center', 'elementor' ),
					'flex-end' => Leo_Helper::__( 'End', 'elementor' ),
					'space-between' => Leo_Helper::__( 'Space Between', 'elementor' ),
					'space-around' => Leo_Helper::__( 'Space Around', 'elementor' ),
					'space-evenly' => Leo_Helper::__( 'Space Evenly', 'elementor' ),
				],
...
//					'{{WRAPPER}}.elementor-column > .elementor-column-wrap > .elementor-widget-wrap' => 'text-align : {{VALUE}}',
					'{{WRAPPER}}.elementor-column > .elementor-column-wrap > .elementor-widget-wrap > .elementor-element' => 'width:auto',
				],
			]
		);
