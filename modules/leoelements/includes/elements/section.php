...
class Element_Section extends Element_Base {
	...
	public function get_title() {
		return Leo_Helper::__( 'Section', 'elementor' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'section_layout',
			[
				'label' => Leo_Helper::__( 'Layout', 'elementor' ),
		...
		$this->add_control(
			'stretch_section',
			[
				'label' => Leo_Helper::__( 'Stretch Section', 'elementor' ),
				'type' => Controls_Manager::SWITCHER,
				'default' => '',
				'return_value' => 'section-stretched',
				'prefix_class' => 'elementor-',
				'hide_in_inner' => true,
				'description' => Leo_Helper::__( 'Stretch the section to the full width of the page using JS.', 'elementor' ) . sprintf( ' <a href="%1$s" target="_blank">%2$s</a>', 'https://subdomain.leoelements.com/stretch-section/', Leo_Helper::__( 'Learn more.', 'elementor' ) ),
				'render_type' => 'none',
		...
		$this->add_control(
			...
			[
				...
				'default' => 'boxed',
				'options' => [
					'boxed' => Leo_Helper::__( 'Boxed', 'elementor' ),
					'full_width' => Leo_Helper::__( 'Full Width', 'elementor' ),
				],
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'no' => Leo_Helper::__( 'No Gap', 'elementor' ),
					'narrow' => Leo_Helper::__( 'Narrow', 'elementor' ),
					'extended' => Leo_Helper::__( 'Extended', 'elementor' ),
					'wide' => Leo_Helper::__( 'Wide', 'elementor' ),
					'wider' => Leo_Helper::__( 'Wider', 'elementor' ),
		...
		$this->add_responsive_control(
			'gap_columns_custom',
			[
				'label' => Leo_Helper::__( 'Custom Columns Gap', 'elementor' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 0,
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'default' => Leo_Helper::__( 'Default', 'elementor' ),
					'full' => Leo_Helper::__( 'Fit To Screen', 'elementor' ),
					'min-height' => Leo_Helper::__( 'Min Height', 'elementor' ),
				],
		...
		$this->add_responsive_control(
			'custom_height',
			[
				'label' => Leo_Helper::__( 'Minimum Height', 'elementor' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => 400,
				],
		...
		$this->add_control(
			...
			[
				...
				'prefix_class' => 'elementor-section-height-inner-',
				'hide_in_top' => true,
			]
		);
		...
		$this->add_control(
			'column_position',
			[
				'label' => Leo_Helper::__( 'Column Position', 'elementor' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'middle',
				'options' => [
					'stretch' => Leo_Helper::__( 'Stretch', 'elementor' ),
		...
		$this->add_control(
			'content_position',
			[
				'label' => Leo_Helper::__( 'Content Position', 'elementor' ),
				'type' => Controls_Manager::SELECT,
				'default' => '',
				'options' => [
					...
					'middle' => Leo_Helper::__( 'Middle', 'elementor' ),
					'bottom' => Leo_Helper::__( 'Bottom', 'elementor' ),
					'space-between' => Leo_Helper::__( 'Space Between', 'elementor' ),
					'space-around' => Leo_Helper::__( 'Space Around', 'elementor' ),
					'space-evenly' => Leo_Helper::__( 'Space Evenly', 'elementor' ),
				],
		...
		$this->add_control(
			'overflow',
			[
				'label' => Leo_Helper::__( 'Overflow', 'elementor' ),
				'type' => Controls_Manager::SELECT,
				'default' => '',
				'options' => [
					'' => Leo_Helper::__( 'Default', 'elementor' ),
					'hidden' => Leo_Helper::__( 'Hidden', 'elementor' ),
				],
				'selectors' => [
		...
		$this->add_control(
			'html_tag',
			[
				'label' => Leo_Helper::__( 'HTML Tag', 'elementor' ),
				'type' => Controls_Manager::SELECT,
				'options' => $options,
				'separator' => 'before',
			]
		...
		$this->add_control(
			'structure',
			[
				'label' => Leo_Helper::__( 'Structure', 'elementor' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => Leo_Helper::__( 'Background Overlay', 'elementor' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			'overlay_blend_mode',
			[
				'label' => Leo_Helper::__( 'Blend Mode', 'elementor' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => Leo_Helper::__( 'Shape Divider', 'elementor' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		foreach ( [
			...
			$this->add_control(
				...
				[
					'label' => Leo_Helper::__( 'Flip', 'elementor' ),
					'type' => Controls_Manager::SWITCHER,
					'condition' => [
			...
			$this->add_control(
				...
				[
					'label' => Leo_Helper::__( 'Invert', 'elementor' ),
					'type' => Controls_Manager::SWITCHER,
					'frontend_available' => true,
					'condition' => [
			...
			$this->add_control(
				...
				[
					'label' => Leo_Helper::__( 'Bring to Front', 'elementor' ),
					'type' => Controls_Manager::SWITCHER,
					'selectors' => [
		...
		$this->start_controls_section(
			'section_typo',
			[
				'label' => Leo_Helper::__( 'Typography', 'elementor' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		if ( in_array( Scheme_Color::get_type(), Schemes_Manager::get_enabled_schemes(), true ) ) {
			$this->add_control(
				...
				[
					...
					'raw' => Leo_Helper::__( 'Note: The following colors won\'t work if Default Colors are enabled.', 'elementor' ),
		...
		$this->add_control(
			'heading_color',
			[
				'label' => Leo_Helper::__( 'Heading Color', 'elementor' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->add_control(
			'color_link',
			[
				'label' => Leo_Helper::__( 'Link Color', 'elementor' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->add_control(
			'color_link_hover',
			[
				'label' => Leo_Helper::__( 'Link Hover Color', 'elementor' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->add_control(
			'text_align',
			[
				'label' => Leo_Helper::__( 'Text Align', 'elementor' ),
		...
		$this->add_control(
			...
			[
				'label' => Leo_Helper::__( 'Reverse Columns', 'elementor' ) . ' (' . Leo_Helper::__( 'Tablet', 'elementor' ) . ')',
				'type' => Controls_Manager::SWITCHER,
				'default' => '',
				'prefix_class' => 'elementor-',
		...
		$this->add_control(
			...
			[
				'label' => Leo_Helper::__( 'Reverse Columns', 'elementor' ) . ' (' . Leo_Helper::__( 'Mobile', 'elementor' ) . ')',
				'type' => Controls_Manager::SWITCHER,
				'default' => '',
				'prefix_class' => 'elementor-',
		...
		$this->add_control(
			'heading_visibility',
			[
				'label' => Leo_Helper::__( 'Visibility', 'elementor' ),
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'prefix_class' => 'elementor-',
				'label_on' => Leo_Helper::__( 'Hide', 'elementor' ),
				'label_off' => Leo_Helper::__( 'Show', 'elementor' ),
	...
	public function before_render() {
		...
		?>
		<<?php echo Leo_Helper::esc_html( $this->get_html_tag() ); ?> <?php $this->print_render_attribute_string( '_wrapper' ); ?>>
			<?php
			...
			?>
			<div class="elementor-container elementor-column-gap-<?php echo Leo_Helper::esc_attr( $settings['gap'] ); ?>">
	...
	public function after_render() {
		...
		</<?php echo Leo_Helper::esc_html( $this->get_html_tag() ); ?>>
		<?php
	}
	...
	private function print_shape_divider( $side ) {
		...
		?>
		<div class="elementor-shape elementor-shape-<?php echo Leo_Helper::esc_attr( $side ); ?>" data-negative="<?php echo var_export( $negative ); ?>">
