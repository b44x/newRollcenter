...
class Fonts {
	 ...
	 * The local font name.
	 */
	const TUANVU_UPLOAD = 'tuanvu_upload';
	...
	public static function get_font_groups() {
		if ( null === self::$font_groups ) {
			$font_groups = [
				self::SYSTEM => Leo_Helper::__( 'System', 'elementor' ),
				self::TUANVU_UPLOAD => Leo_Helper::__( 'Upload', 'elementor' ),
				self::GOOGLE => Leo_Helper::__( 'Google', 'elementor' ),
				self::EARLYACCESS => Leo_Helper::__( 'Google Early Access', 'elementor' ),
			];
			 ...
			 */
			$font_groups = Leo_Helper::apply_filters( 'elementor/fonts/groups', $font_groups );
	...
	public static function get_fonts() {
		if ( null === self::$fonts ) {
			 ...
			 */
			$additional_fonts = Leo_Helper::apply_filters( 'elementor/fonts/additional_fonts', $additional_fonts );
...
//                        $custom_fonts['Rajdhani'] = self::SYSTEM;
//                        $custom_fonts['Teko'] = self::GOOGLE;
//                        $custom_fonts['Barlow'] = self::SYSTEM;
//                        $custom_fonts['Marcellus'] = self::GOOGLE;
//                        $custom_fonts['Zilla Slab'] = self::SYSTEM;
		}
                require_once(_PS_MODULE_DIR_.'leoelements/classes/LeoElementsProfilesModel.php');
                $upload_fonts = \LeoElementsProfilesModel::getFontFamilyUploaded();
                $google_fonts = \LeoElementsProfilesModel::getFontFamilyGoogle();

                foreach ($upload_fonts as $upload_font) {
//                    $custom_fonts[ $upload_font['id'] . '_' . $upload_font['font_family']] = self::TUANVU_UPLOAD;
                    $custom_fonts[$upload_font['font_family']] = self::TUANVU_UPLOAD;
                }
                foreach ($google_fonts as $google_font) {
                    $custom_fonts[$google_font['font_family']] = self::GOOGLE;
                }
