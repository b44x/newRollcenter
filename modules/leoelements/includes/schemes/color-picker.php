...
class Scheme_Color_Picker extends Scheme_Color {
	...
	public static function get_description() {
		return Leo_Helper::__( 'Choose which colors appear in the editor\'s color picker. This makes accessing the colors you chose for the site much easier.', 'elementor' );
	}
	...
	protected function _get_current_scheme_title() {
		return Leo_Helper::__( 'Color Picker', 'elementor' );
	}
}
