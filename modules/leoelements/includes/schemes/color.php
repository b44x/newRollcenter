...
class Scheme_Color extends Scheme_Base {
	...
	public function get_title() {
		return Leo_Helper::__( 'Colors', 'elementor' );
	}
	...
	public function get_disabled_title() {
		return Leo_Helper::__( 'Color Palettes', 'elementor' );
	}
	...
	public function get_scheme_titles() {
		return [
			self::COLOR_1 => Leo_Helper::__( 'Primary', 'elementor' ),
			self::COLOR_2 => Leo_Helper::__( 'Secondary', 'elementor' ),
			self::COLOR_3 => Leo_Helper::__( 'Text', 'elementor' ),
			self::COLOR_4 => Leo_Helper::__( 'Accent', 'elementor' ),
		];
	}
	...
	public function print_template_content() {
		...
		<div class="elementor-panel-scheme-colors-more-palettes elementor-panel-box">
			<div class="elementor-panel-heading">
				<div class="elementor-panel-heading-title"><?php echo Leo_Helper::__( 'More Palettes', 'elementor' ); ?></div>
			</div>
			<div class="elementor-panel-box-content">
				<?php foreach ( $this->_get_system_schemes_to_print() as $scheme_name => $scheme ) : ?>
					<div class="elementor-panel-scheme-color-system-scheme" data-scheme-name="<?php echo Leo_Helper::esc_attr( $scheme_name ); ?>">
						<div class="elementor-panel-scheme-color-system-items">
							<?php foreach ( $scheme['items'] as $color_value ) : ?>
								<div class="elementor-panel-scheme-color-system-item" style="background-color: <?php echo Leo_Helper::esc_attr( $color_value ); ?>;"></div>
							<?php endforeach; ?>
						</div>
	...
	protected function _get_current_scheme_title() {
		return Leo_Helper::__( 'Color Palette', 'elementor' );
	}
}
