...
abstract class Source_Base {
	...
	public function get_user_meta( $item = null ) {
		if ( null === $this->user_meta ) {
			$this->user_meta = Leo_Helper::get_user_meta( Leo_Helper::get_current_user_id(), $this->get_user_meta_prefix(), true );
		}
	...
	public function update_user_meta( $key, $value ) {
		...
		return Leo_Helper::update_user_meta( Leo_Helper::get_current_user_id(), $this->get_user_meta_prefix(), $meta );
	}
