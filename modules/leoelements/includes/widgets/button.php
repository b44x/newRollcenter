...
class Widget_Button extends Widget_Base {
	...
	public function get_title() {
		return Leo_Helper::__( 'Button', 'elementor' );
	}
	...
	public static function get_button_sizes() {
		return [
			'xs' => Leo_Helper::__( 'Extra Small', 'elementor' ),
			'sm' => Leo_Helper::__( 'Small', 'elementor' ),
			'md' => Leo_Helper::__( 'Medium', 'elementor' ),
			'lg' => Leo_Helper::__( 'Large', 'elementor' ),
			'xl' => Leo_Helper::__( 'Extra Large', 'elementor' ),
		];
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_button',
			[
				'label' => Leo_Helper::__( 'Button', 'elementor' ),
			]
		);
		...
		$this->add_control(
			'text',
			[
				'label' => Leo_Helper::__( 'Text', 'elementor' ),
				'type' => Controls_Manager::TEXT,
				'default' => Leo_Helper::__( 'Click here', 'elementor' ),
				'placeholder' => Leo_Helper::__( 'Click here', 'elementor' ),
			]
		);
		...
		$this->add_control(
			'icon_align',
			[
				'label' => Leo_Helper::__( 'Icon Position', 'elementor' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'left',
				'options' => [
					'left' => Leo_Helper::__( 'Before', 'elementor' ),
					'right' => Leo_Helper::__( 'After', 'elementor' ),
				],
				'condition' => [
					'selected_icon[value]!' => '',
				],
		...
		$this->add_control(
			'icon_indent',
			[
				'label' => Leo_Helper::__( 'Icon Spacing', 'elementor' ),
				...
				'selectors' => [
					'body:not(.lang-rtl) {{WRAPPER}} .elementor-button .elementor-align-icon-right' => 'margin-left: {{SIZE}}{{UNIT}};',
					'body:not(.lang-rtl) {{WRAPPER}} .elementor-button .elementor-align-icon-left' => 'margin-right: {{SIZE}}{{UNIT}};',
                                    
					'body.lang-rtl {{WRAPPER}} .elementor-button .elementor-align-icon-right' => 'margin-right: {{SIZE}}{{UNIT}};',
					'body.lang-rtl {{WRAPPER}} .elementor-button .elementor-align-icon-left' => 'margin-left: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			'button_css_id',
			[
				'label' => Leo_Helper::__( 'Button ID', 'elementor' ),
				'type' => Controls_Manager::TEXT,
				'default' => '',
				'title' => Leo_Helper::__( 'Add your custom id WITHOUT the Pound key. e.g: my-id', 'elementor' ),
				'label_block' => false,
				'description' => Leo_Helper::__( 'Please make sure the ID is unique and not used elsewhere on the page this form is displayed. This field allows <code>A-z 0-9</code> & underscore chars without spaces.', 'elementor' ),
				'separator' => 'before',
		...
		<span <?php echo $this->get_render_attribute_string( 'content-wrapper' ); ?>>
			...
			<span <?php echo $this->get_render_attribute_string( 'icon-align' ); ?>>
				<?php if ( $is_new || $migrated ) {
					...
					<i class="<?php echo Leo_Helper::esc_attr( $settings['icon'] ); ?>" aria-hidden="true"></i>
				<?php } ?>
			</span>
			<?php endif; ?>
