...
class Widget_Heading extends Widget_Base {
	...
	public function get_title() {
		return Leo_Helper::__( 'Heading', 'elementor' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => Leo_Helper::__( 'Add Your Heading Text Here', 'elementor' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'small' => Leo_Helper::__( 'Small', 'elementor' ),
					'medium' => Leo_Helper::__( 'Medium', 'elementor' ),
					'large' => Leo_Helper::__( 'Large', 'elementor' ),
					'xl' => Leo_Helper::__( 'XL', 'elementor' ),
					'xxl' => Leo_Helper::__( 'XXL', 'elementor' ),
				],
			]
		);
