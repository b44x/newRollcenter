...
class Widget_Icon_Box extends Widget_Base {
	...
	public function get_title() {
		return Leo_Helper::__( 'Icon Box', 'elementor' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_icon',
			[
				'label' => Leo_Helper::__( 'Icon Box', 'elementor' ),
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'body.lang-rtl {{WRAPPER}}.elementor-position-right .elementor-icon-box-icon' => 'margin-right: {{SIZE}}{{UNIT}};',
					'body.lang-rtl {{WRAPPER}}.elementor-position-left .elementor-icon-box-icon' => 'margin-left: {{SIZE}}{{UNIT}};',
                                    
					'body:not(.lang-rtl) {{WRAPPER}}.elementor-position-right .elementor-icon-box-icon' => 'margin-left: {{SIZE}}{{UNIT}};',
					'body:not(.lang-rtl) {{WRAPPER}}.elementor-position-left .elementor-icon-box-icon' => 'margin-right: {{SIZE}}{{UNIT}};',
...
//					'(mobile){{WRAPPER}} .elementor-icon-box-icon' => 'margin-bottom: {{SIZE}}{{UNIT}};',
		...
		$this->add_control(
			'rotate',
			[
				'label' => Leo_Helper::__( 'Rotate', 'elementor' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => 0,
					'unit' => 'deg',
