...
class Widget_Icon_List extends Widget_Base {
	...
	public function get_title() {
		return Leo_Helper::__( 'Icon List', 'elementor' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_icon',
			[
				'label' => Leo_Helper::__( 'Icon List', 'elementor' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'traditional' => [
						'title' => Leo_Helper::__( 'Default', 'elementor' ),
						'icon' => 'eicon-editor-list-ul',
					],
					'inline' => [
						'title' => Leo_Helper::__( 'Inline', 'elementor' ),
		...
		$repeater->add_control(
			...
			[
				...
				'type' => Controls_Manager::TEXTAREA,
                                'rows'    => '1',
				'label_block' => true,
				'placeholder' => Leo_Helper::__( 'List Item', 'elementor' ),
				'default' => Leo_Helper::__( 'List Item', 'elementor' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => [
					[
						'text' => Leo_Helper::__( 'List Item #1', 'elementor' ),
						'selected_icon' => [
							'value' => 'fas fa-check',
							'library' => 'fa-solid',
						],
					...
					[
						'text' => Leo_Helper::__( 'List Item #2', 'elementor' ),
						'selected_icon' => [
							'value' => 'fas fa-times',
							'library' => 'fa-solid',
						],
					...
					[
						'text' => Leo_Helper::__( 'List Item #3', 'elementor' ),
						'selected_icon' => [
		...
		$this->start_controls_section(
			'section_icon_list',
			[
				'label' => Leo_Helper::__( 'List', 'elementor' ),
		...
		$this->add_control(
			'text_indent',
			[
				'label' => Leo_Helper::__( 'Text Indent', 'elementor' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'max' => 50,
				...
				'selectors' => [
					'{{WRAPPER}} .elementor-icon-list-text' => Leo_Helper::is_rtl() ? 'padding-right: {{SIZE}}{{UNIT}};' : 'padding-left: {{SIZE}}{{UNIT}};',
				],
			]
		);
						...
						<span class="elementor-icon-list-icon">
							...
							if ( $is_new || $migrated ) {
								Icons_Manager::render_icon( $item['selected_icon'], [ 'aria-hidden' => 'true' ] );
									...
									<i class="<?php echo Leo_Helper::esc_attr( $item['icon'] ); ?>" aria-hidden="true"></i>
							<?php } ?>
						</span>
					<?php endif; ?>
