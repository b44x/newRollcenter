...
class Widget_Star_Rating extends Widget_Base {
	...
	public function get_title() {
		return Leo_Helper::__( 'Star Rating', 'elementor' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_rating',
			[
				'label' => Leo_Helper::__( 'Rating', 'elementor' ),
			]
		);
		...
		$this->add_control(
			'rating_scale',
			[
				'label' => Leo_Helper::__( 'Rating Scale', 'elementor' ),
		...
		$this->add_control(
			'unmarked_star_style',
			[
				'label' => Leo_Helper::__( 'Unmarked Style', 'elementor' ),
				'type' => Controls_Manager::CHOOSE,
				'label_block' => false,
				'options' => [
					'solid' => [
						'title' => Leo_Helper::__( 'Solid', 'elementor' ),
						'icon' => 'eicon-star',
					],
					'outline' => [
						'title' => Leo_Helper::__( 'Outline', 'elementor' ),
						'icon' => 'eicon-star-o',
					],
				],
				'default' => 'solid',
		...
		$this->start_controls_section(
			'section_stars_style',
			[
				'label' => Leo_Helper::__( 'Stars', 'elementor' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => Leo_Helper::__( 'Unmarked Color', 'elementor' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
