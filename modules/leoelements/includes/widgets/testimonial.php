...
class Widget_Testimonial extends Widget_Base {
	...
	public function get_title() {
		return Leo_Helper::__( 'Testimonial', 'elementor' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_testimonial',
			[
				'label' => Leo_Helper::__( 'Testimonial', 'elementor' ),
			]
		);
		...
		$this->add_control(
			'testimonial_name',
			[
				'label' => Leo_Helper::__( 'Name', 'elementor' ),
		...
		$this->add_control(
			...
			[
				...
				'default' => 'aside',
				'options' => [
					'aside' => Leo_Helper::__( 'Aside', 'elementor' ),
		...
		$this->add_control(
			'image_size',
			[
				'label' => Leo_Helper::__( 'Image Size', 'elementor' ),
