...
class Widget_Video extends Widget_Base {
	...
	public function get_title() {
		return Leo_Helper::__( 'Video', 'elementor' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_video',
			[
				'label' => Leo_Helper::__( 'Video', 'elementor' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => 'youtube',
				'options' => [
					'youtube' => Leo_Helper::__( 'YouTube', 'elementor' ),
					'vimeo' => Leo_Helper::__( 'Vimeo', 'elementor' ),
					'dailymotion' => Leo_Helper::__( 'Dailymotion', 'elementor' ),
					//'hosted' => Leo_Helper::__( 'Self Hosted', 'elementor' ),
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'placeholder' => Leo_Helper::__( 'Enter your URL', 'elementor' ) . ' (YouTube)',
		...
		$this->add_control(
			...
			[
				'label' => Leo_Helper::__( 'Link', 'elementor' ),
				'type' => Controls_Manager::TEXT,
				'placeholder' => Leo_Helper::__( 'Enter your URL', 'elementor' ) . ' (Vimeo)',
		...
		$this->add_control(
			...
			[
				'label' => Leo_Helper::__( 'Link', 'elementor' ),
				'type' => Controls_Manager::TEXT,
				'placeholder' => Leo_Helper::__( 'Enter your URL', 'elementor' ) . ' (Dailymotion)',
		...
		$this->add_control(
			'insert_url',
			[
				'label' => Leo_Helper::__( 'External URL', 'elementor' ),
		...
		$this->add_control(
			'hosted_url',
			[
				'label' => Leo_Helper::__( 'Choose File', 'elementor' ),
		...
		$this->add_control(
			'external_url',
			[
				'label' => Leo_Helper::__( 'URL', 'elementor' ),
				...
				'show_label' => false,
				'media_type' => 'video',
				'placeholder' => Leo_Helper::__( 'Enter your URL', 'elementor' ),
				'condition' => [
					'video_type' => 'hosted',
					'insert_url' => 'yes',
				],
		...
		$this->add_control(
			'video_options',
			[
				'label' => Leo_Helper::__( 'Video Options', 'elementor' ),
		...
		$this->add_control(
			'mute',
			[
				'label' => Leo_Helper::__( 'Mute', 'elementor' ),
				'type' => Controls_Manager::SWITCHER,
			]
		);
		...
		$this->add_control(
			'loop',
			[
				'label' => Leo_Helper::__( 'Loop', 'elementor' ),
				'type' => Controls_Manager::SWITCHER,
				'condition' => [
					'video_type!' => 'dailymotion',
				],
		...
		$this->add_control(
			'controls',
			[
				'label' => Leo_Helper::__( 'Player Controls', 'elementor' ),
				'type' => Controls_Manager::SWITCHER,
				'label_off' => Leo_Helper::__( 'Hide', 'elementor' ),
				'label_on' => Leo_Helper::__( 'Show', 'elementor' ),
				'default' => 'yes',
				'condition' => [
					'video_type!' => 'vimeo',
				],
		...
		$this->add_control(
			'showinfo',
			[
				'label' => Leo_Helper::__( 'Video Info', 'elementor' ),
				'type' => Controls_Manager::SWITCHER,
				'label_off' => Leo_Helper::__( 'Hide', 'elementor' ),
				'label_on' => Leo_Helper::__( 'Show', 'elementor' ),
				'default' => 'yes',
		...
		$this->add_control(
			'modestbranding',
			[
				'label' => Leo_Helper::__( 'Modest Branding', 'elementor' ),
				'type' => Controls_Manager::SWITCHER,
				'condition' => [
					'video_type' => [ 'youtube' ],
					'controls' => 'yes',
		...
		$this->add_control(
			'logo',
			[
				'label' => Leo_Helper::__( 'Logo', 'elementor' ),
				'type' => Controls_Manager::SWITCHER,
				'label_off' => Leo_Helper::__( 'Hide', 'elementor' ),
				'label_on' => Leo_Helper::__( 'Show', 'elementor' ),
				'default' => 'yes',
		...
		$this->add_control(
			'color',
			[
				'label' => Leo_Helper::__( 'Controls Color', 'elementor' ),
		...
		$this->add_control(
			'yt_privacy',
			[
				'label' => Leo_Helper::__( 'Privacy Mode', 'elementor' ),
				'type' => Controls_Manager::SWITCHER,
				'description' => Leo_Helper::__( 'When you turn on privacy mode, YouTube won\'t store information about visitors on your website unless they play the video.', 'elementor' ),
				'condition' => [
					'video_type' => 'youtube',
				],
			]
		...
		$this->add_control(
			'rel',
			[
				'label' => Leo_Helper::__( 'Suggested Videos', 'elementor' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'' => Leo_Helper::__( 'Current Video Channel', 'elementor' ),
					'yes' => Leo_Helper::__( 'Any Video', 'elementor' ),
				],
				'condition' => [
					'video_type' => 'youtube',
				],
		...
		$this->add_control(
			'vimeo_title',
			[
				'label' => Leo_Helper::__( 'Intro Title', 'elementor' ),
				'type' => Controls_Manager::SWITCHER,
				'label_off' => Leo_Helper::__( 'Hide', 'elementor' ),
				'label_on' => Leo_Helper::__( 'Show', 'elementor' ),
				'default' => 'yes',
		...
		$this->add_control(
			'vimeo_portrait',
			[
				'label' => Leo_Helper::__( 'Intro Portrait', 'elementor' ),
				'type' => Controls_Manager::SWITCHER,
				'label_off' => Leo_Helper::__( 'Hide', 'elementor' ),
				'label_on' => Leo_Helper::__( 'Show', 'elementor' ),
				'default' => 'yes',
		...
		$this->add_control(
			'vimeo_byline',
			[
				'label' => Leo_Helper::__( 'Intro Byline', 'elementor' ),
				'type' => Controls_Manager::SWITCHER,
				'label_off' => Leo_Helper::__( 'Hide', 'elementor' ),
				'label_on' => Leo_Helper::__( 'Show', 'elementor' ),
				'default' => 'yes',
		...
		$this->add_control(
			'download_button',
			[
				'label' => Leo_Helper::__( 'Download Button', 'elementor' ),
				'type' => Controls_Manager::SWITCHER,
				'label_off' => Leo_Helper::__( 'Hide', 'elementor' ),
				'label_on' => Leo_Helper::__( 'Show', 'elementor' ),
				'condition' => [
		...
		$this->add_control(
			'poster',
			[
				'label' => Leo_Helper::__( 'Poster', 'elementor' ),
				'type' => Controls_Manager::MEDIA,
				'condition' => [
					'video_type' => 'hosted',
				],
		...
		$this->start_controls_section(
			...
			[
				'label' => Leo_Helper::__( 'Image Overlay', 'elementor' ),
			]
		);
		...
		$this->add_control(
			'lazy_load',
			[
				'label' => Leo_Helper::__( 'Lazy Load', 'elementor' ),
				'type' => Controls_Manager::SWITCHER,
				'condition' => [
					'show_image_overlay' => 'yes',
					'video_type!' => 'hosted',
		...
		$this->add_control(
			'show_play_icon',
			[
				'label' => Leo_Helper::__( 'Play Icon', 'elementor' ),
				'type' => Controls_Manager::SWITCHER,
				'default' => 'yes',
				'condition' => [
					'show_image_overlay' => 'yes',
		...
		$this->add_control(
			'aspect_ratio',
			[
				'label' => Leo_Helper::__( 'Aspect Ratio', 'elementor' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'169' => '16:9',
					'219' => '21:9',
		...
		$this->add_group_control(
			...
			[
				...
				'fields_options' => [
					'text_shadow_type' => [
						'label' => Leo_Helper::_x( 'Shadow', 'Text Shadow Control', 'elementor' ),
					],
				],
				'condition' => [
					'show_image_overlay' => 'yes',
		...
		$this->add_control(
			...
			[
				...
				'frontend_available' => true,
				'options' => [
					'' => Leo_Helper::__( 'Center', 'elementor' ),
				...
				<div <?php echo $this->get_render_attribute_string( 'image-overlay' ); ?>>
					...
					<?php if ( 'yes' === $settings['show_play_icon'] ) : ?>
						<div class="elementor-custom-embed-play" role="button">
							...
							<span class="elementor-screen-only"><?php echo Leo_Helper::__( 'Play Video', 'elementor' ); ?></span>
						</div>
					<?php endif; ?>
				</div>
			<?php } ?>
