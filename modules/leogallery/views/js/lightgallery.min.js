...
var leogallery = {
    ...
    buildSlider: function(){
        ...
        this.lightSlider = $('#lightSlider').lightSlider(leoGallerySliderConfig);
    ...
    scrollPager: function(pos){
        ...
        leogallery.pagerPos = leogallery.pagerPos + pos;
        if (leogallery.pagerPos < 0) {
            leogallery.pagerPos = 0;
        }
        if (leogallery.pagerPos + 5 > slideCount) {
            leogallery.pagerPos = slideCount - 5;
        }
        $pager.css({
            transform: 'translate3d(-' + (leogallery.pagerPos*slideWidth) + 'px, 0px, 0px)'
        });
    }
};