...
<div class="lql-social-login clearfix {if $show_button_text}show-bt-txt{/if}">
	...
	{if isset($leo_captcha) && $leo_captcha}
		<div class="form-group lql-form-content-element">
			<img src="{$captcha_social_url}">
			<input type="text" class="form-control lql-register-captcha" name="lql-register-captcha-social" required="" placeholder="{l s='Captcha' mod='leoquicklogin'}">
		</div>
	{/if}
