...
class SizeGuideModel extends ObjectModel
{
	public $title;
	public $description;
	public $active;
	...
	public static $definition = array(
		'table' => 'leosizechart_guides',
		'primary' => 'id_leosizechart_guides',
		'multilang' => true,
		'fields' => array(
	...
	public function add($autodate = true, $null_values = false)
	{
		...
		$res &= Db::getInstance()->execute('
			INSERT INTO `'._DB_PREFIX_.'leosizechart` (`id_shop`, `id_leosizechart_guides`)
	...
	public function delete()
	{
		...
		$res &= Db::getInstance()->execute('
			DELETE FROM `'._DB_PREFIX_.'leosizechart`
			WHERE `id_leosizechart_guides` = '.(int)$this->id
		);

		$res &= Db::getInstance()->execute('
			DELETE FROM `'._DB_PREFIX_.'leosizechart_product`
	...
	public static function getProductGuide($id_product)
	{
		return Db::getInstance(_PS_USE_SQL_SLAVE_)->getValue('
			SELECT `id_guide`
			FROM '._DB_PREFIX_.'leosizechart_product 
	...
	public static function assignProduct($id_product, $id_guide)
	{
		...
		$res &= Db::getInstance()->execute('
			INSERT INTO `'._DB_PREFIX_.'leosizechart_product` (`id_product`, `id_guide`) 
