			...
			{foreach from=$sliders key=k item=slider}
				{if $slider.video.active}
					...
					<div data-leo_image="{$slider.thumbnail|escape:'html':'UTF-8'}"
						...
						<iframe src="{$slider.video.videoURL|escape:'html':'UTF-8'}?title=0&amp;byline=0&amp;portrait=0;api=1" width="100%" height="100%" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen{if $slider.video.videoauto} allow="autoplay"{/if}></iframe>
					</div>
					<!-- SLIDE VIDEO END -->
				{else}
