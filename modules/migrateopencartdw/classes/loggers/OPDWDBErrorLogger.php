...
class OPDWDBErrorLogger extends ObjectModel
{
    const TYPE_TAX = 't';
    ...
    public static function addErrorLog($logText, $entityType)
    {
        ...
        $sql = "INSERT INTO " . _DB_PREFIX_ . "opdw_warning_logs SET log_text = '" . pSQL($logText) . "', entity_type = '" . pSQL($type) . "', log_date_add = '" . date('Y-m-d h:i:s', time()) . "'";
    ...
    {
        $sql = 'DELETE FROM ' . _DB_PREFIX_ . 'opdw_warning_logs';
