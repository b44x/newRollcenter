...
<section id="main" class="product-detail product_image_gallery product-image-gallery"><div class="row"><div class="col-md-6 col-lg-6 col-xl-6 col-sm-12 col-xs-12 col-sp-12">
{block name='page_content_container'}
  <section class="page-content" id="content" data-templatezoomtype="in" data-zoomposition="right" data-zoomwindowwidth="400" data-zoomwindowheight="400" data-use_leo_gallery="1">
...
{/block}{hook h='displayLeoNextPrevious' product=$product}
