 ...
 *}
<section class="featured-products  bestseller-products clearfix block">
    ...
    <div class="block_content">
        ...
        {else}
         ...
         {/if}
        <a class="all-product-link float-xs-left float-md-right btn-outline h4" href="{$allBestSellers}">
