...
<div id="js-product-list">
 {if !isset($profile_params) || (isset($profile_params) && !$profile_params)}
      {assign var="leoElementConfig" value={hook h="leoElementConfig" configName="productListParams"}}
      {assign var="profile_params" value=json_decode($leoElementConfig, true)}
